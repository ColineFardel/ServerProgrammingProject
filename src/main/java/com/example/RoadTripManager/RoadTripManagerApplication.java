...
public class RoadTripManagerApplication {
	...
	public CommandLineRunner demo(TripRepository triprepository, DayRepository dayrepository,
		...
		return (args) -> {
			...
			/*
			 * log.info("save some trips"); triprepository.save(new Trip("Italie-2021"));
			 * triprepository.save(new Trip("France-2023")); triprepository.save(new
			 * Trip("Suisse-2025"));
			 * 
			 * log.info("save some days"); dayrepository.save(new Day("05.11.2020",
			 * triprepository.findById((long) 1).get()));
			 * 
			 * log.info("save some routes"); routerepository.save( new Route("Sion",
			 * "Lausanne", "12:30", "13:24",
			 * dayrepository.findByDate("05.11.2020").get(0)));
			 * 
			 * log.info("save some places"); placerepository.save(new Place("Sion",
			 * "Tourbillon", dayrepository.findByDate("05.11.2020").get(0)));
			 * 
			 * log.info("save some sleep places"); sleeprepository.save(new Sleep("Sion",
			 * "18:00", 125, "Hotel", dayrepository.findByDate("05.11.2020").get(0)));
			 * 
			 ...
			 * 
			 * log.info("fetch all trips"); for (Trip trip : triprepository.findAll()) {
